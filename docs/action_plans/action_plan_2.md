...
2. [x] **Create the voice feature folder and state model**
...
3. [x] **Implement microphone permission flow**
...
4. [x] **Create `SpeechToTextService`**
...
5. [x] **Create `TextToSpeechService`**
...
6. [x] **Wire `VoiceController` into the existing chat pipeline**
...
7. [x] **Add push-to-talk UI to ChatPage**
...
8. [x] **Support interruption and cancellation**
...
9. [x] **Add tests for voice state transitions**
